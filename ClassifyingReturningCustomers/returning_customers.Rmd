...
## 1. Imports
```{r import, message = FALSE, results = 'hold'}
# Import libraries
library(dplyr)
library(BTYD)
library(MLmetrics)
...
```{r basic statistics, message = FALSE}
# Basic statistics
df_basicstats <- df %>%
